...
def get_text_fade_animation(mp_widget, fade_envelope, text, location, size, color, font_name, anchor_type=None):
    (fade_in_time, hold_time, fade_out_time) = fade_envelope
    (x, y) = location
